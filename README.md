...
| `start(callback, errorCallback, contextId)`                                          | Start/restart tracking      |
| `switchChannel(channelId, resolution, delivery, callback, errorCallback, contextId)` | Switch to different channel |
